...
typedef void (*schur_number_task_t)(schur_number_task_arg_t *arg);

schur_number_method_t initial_build_method(schur_number_method_t func);
schur_number_task_t select_thread_task(schur_number_method_t func);
