//
//  schur_number_unorganized_memory.c
//  SchurNumber
//
...
struct sftest_ind_struc {
    mp_limb_t indexes;
    mp_size_t limbsize;
    unsigned int shift;
};

typedef struct sftest_ind_struc sftest_ind_t;
...
char unorgtestperform(unsigned long i, sftest_ind_t *sftests, mp_limb_t *set, mp_limb_t *setinvert, mp_size_t limballoc, mp_limb_t *work0, mp_limb_t *work1) {
...
void unorgtestdelete(sftest_ind_t *sftests, mp_limb_t *set, mp_limb_t *setinvert, mp_size_t limballoc, mp_limb_t *work0, mp_limb_t *work1) {
...
unsigned long schurNumberIterUnstackUnorganizedMemory(unsigned long pmax, unsigned long *nbests, mpz_t iternum) {
    /*
    ...
    memory = calloc(pmax*mp_bits_per_limb, sizeof(sftest_ind_t));
    for (i=0; i<pmax; i++) {
